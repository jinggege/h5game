    ...
    (function (background) {
        var BackgroundC = (function (_super) {
            ...
            BackgroundC.prototype.open = function () {
                if (super.getBgimg.call(this).texture == undefined) {
                    super.getBgimg.call(this).texture = manage.LoadManage.instance().getTextureByName(config.ResKey.GAME_BG_NAME);
                    super.getBtnStart.call(this).texture = manage.LoadManage.instance().getTextureByName(config.ResKey.BTN_OK);
                    super.getBtnStart.call(this).addEventListener(egret.TouchEvent.TOUCH_TAP, this.clickStartHandler, this);
                }
            };
            BackgroundC.prototype.clickStartHandler = function (event) {
                super.getBtnStart.call(this).visible = false;
        ...
        background.BackgroundC = BackgroundC; //end export
    })(background = view.background || (view.background = {}));
})(view || (view = {})); //end module
//# sourceMappingURL=BackgroundC.js.map